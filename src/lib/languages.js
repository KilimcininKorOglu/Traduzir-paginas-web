...
const twpLang = (function () {
   ...
   */
  twpLang.getAlternativeService = function getAlternativeService(lang, serviceName, forPage) {
    lang = twpLang.fixTLanguageCode(lang);
    if (!twpLang.SupportedLanguages.google) return null;
    if (twpLang.SupportedLanguages.google.indexOf(lang) !== -1) return serviceName;
    return null;
  };
